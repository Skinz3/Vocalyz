...
namespace Vocalyz.DesignPattern
{
    public class DevelopmentManager
    {
        ...
        public const string TypeLog = "Class: {0} | State: {1} | Comment: {2}";
        public const string MethodLog = "Method: {0}() | Class: {1} | State: {2} | Comment: {3}";
        public const string FieldLog = "Field: {0} | Class: {1} | State: {2} | Comment: {3}";

        public static string Analyse(Assembly assembly)
        {
            string result = string.Empty;
            result += "Starting analysis (" + assembly.GetName().Name + ")" + Environment.NewLine + Environment.NewLine;
